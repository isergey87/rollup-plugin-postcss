# rollup-plugin-postcss-mi

Fork of rollup-plugin-postcss with supporting separate CSS extract

`separateCSS` if need separate export
`separateRelative` - default `src` - relative path for exported css

[![NPM version](https://img.shields.io/npm/v/rollup-plugin-postcss-mi.svg?style=flat)](https://npmjs.com/package/rollup-plugin-postcss-mi) 
[![NPM downloads](https://img.shields.io/npm/dm/rollup-plugin-postcss-mi.svg?style=flat)](https://npmjs.com/package/rollup-plugin-postcss-mi)
